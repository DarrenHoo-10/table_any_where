const SFG_PUBLIC_BASE_PATH = window.location.pathname.includes('/games/')
  ? window.location.pathname.split('/games/')[0]
  : window.location.pathname.replace(/\/+$/g, '');

window.SFG_CONFIG = {
  publicBasePath: SFG_PUBLIC_BASE_PATH,
  visual: {
    ...
    chairAssetUrl: `${SFG_PUBLIC_BASE_PATH}/assets/models/armchair-01-game.glb`,
    cardAssetBaseUrl: `${SFG_PUBLIC_BASE_PATH}/assets/cards/ornate-v1`,
  },
};
